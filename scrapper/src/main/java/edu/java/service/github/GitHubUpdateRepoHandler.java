...
public class GitHubUpdateRepoHandler {
    ...
    public GitHubUpdateRepoResult handle(String owner, String repository, String lastUpdateDate) {
        ...
        return new GitHubUpdateRepoResult(eventResponses.stream().map(this::getEventDescription)
    ...
    private String getEventDescription(EventResponse eventResponse) {
        if (eventResponse instanceof CommitCommentEventResponse commitCommentEventResponse) {
            return buildCommitCommentDescription(commitCommentEventResponse);
        } else if (eventResponse instanceof IssueEventResponse issueEventResponse) {
            return buildIssueCommentDescription(issueEventResponse);
        } else if (eventResponse instanceof CreateEventsResponse createEventsResponse) {
            return buildCreateEventDescription(createEventsResponse);
        } else if (eventResponse instanceof PushEventResponse pushEventResponse) {
            return buildPushEventDescription(pushEventResponse);
        }
        return null;
    }

    private String buildCommitCommentDescription(CommitCommentEventResponse commitCommentEventResponse) {
    ...
    private String buildIssueCommentDescription(IssueEventResponse issueEventResponse) {
        return String.format(
    ...
    private String buildCreateEventDescription(CreateEventsResponse createEventsResponse) {
        return String.format(
    ...
    private String buildPushEventDescription(PushEventResponse pushEventResponse) {
        return String.format(
